...
1. 先看 [快速开始](/docs/01.guide/02.quick-start) - 5 分钟上手
2. 再看 [配置说明](/docs/01.guide/03.config) - 了解 `repostack.yaml` 完整格式
3. 了解 [Lock 文件](/docs/01.guide/06.lock-file) - 版本锁定的核心机制
4. 如果要理解快照语义，再看 [Snapshot 与 Sync](/docs/01.guide/04.snapshot-and-sync)
5. **重要**：理解 [Stack Root 作为 Git 仓库](/docs/01.guide/05.stack-root-git) - 时间旅行的基础
6. 需要查命令时，去看 [CLI 总览](/docs/02.cli/01.index) 和 [命令参考](/docs/02.cli/commands)
